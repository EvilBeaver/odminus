...
Функция Index() Экспорт
	...
	Если Не ВозможноПродолжениеОперацииАдминистрирования() Тогда
	...
	Исключение
		Возврат ОбработкаОшибкиАвторизации(ОписаниеОшибки());
	КонецПопытки;

КонецФункции

Функция ВозможноПродолжениеОперацииАдминистрирования()
...
Функция ОбработкаОшибкиАвторизации(ОписаниеОшибки)
