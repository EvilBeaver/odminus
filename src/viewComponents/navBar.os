...
Функция ПолучитьДеревоНавигации()
	...
	Если Сессия.Доступна Тогда
		АктивноеДеревоJson = Сессия.ПолучитьСтроку("Sidebar/" + ЗначенияМаршрута["agent"]);
		Если АктивноеДеревоJson <> Неопределено Тогда
			АктивноеДерево = ПрочитатьДеревоИзJson(АктивноеДеревоJson);
		КонецЕсли;
	КонецЕсли;
